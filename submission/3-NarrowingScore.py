...
from data import ID_TO_NAME_MAP_NARROWING as ID_TO_NAME_MAP, NAME_TO_ID_MAP_NARROWING as NAME_TO_ID_MAP
...
hdlr = logging.FileHandler(handle + '/logs/3-narrowingscore.log')
...
columns = [x for x in columns if 'J' in x]
...
logger.info(f'Wrote narrowing output to :{SCOREOUTPUT}!')
